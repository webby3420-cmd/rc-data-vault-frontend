    ...
    <main className="min-h-screen bg-slate-950 text-slate-100">
      <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <p className="mb-10 max-w-2xl text-slate-400 leading-7">
          Explore used Traxxas Slash values, price ranges, and recent sold listing activity
          across live Slash variants. Based on real eBay sold listings.
        </p>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          ...
          >
            ...
            <div className="mt-1 text-sm text-slate-400">
              1/10 brushless 4WD short course truck. High demand used platform.
            </div>
          </a>

          
            href="/rc/traxxas/slash/traxxas-slash-4x4"
            className="rounded-xl border border-slate-700 bg-slate-900 p-5 transition-colors hover:border-slate-500"
          >
            <div className="text-lg font-medium text-white">Traxxas Slash 4X4</div>
            <div className="mt-1 text-sm text-slate-400">
              1/10 4WD brushless short course truck — base and Ultimate variants.
            </div>
          </a>
        </div>
      </div>
