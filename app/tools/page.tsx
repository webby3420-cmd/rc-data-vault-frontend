...
const TOOLS = [
  ...
  {
    href: "/tools/brushed-speed",
    icon: "🔩",
    title: "Brushed Speed Calculator",
    description: "Estimate speed from motor turns, voltage, gearing, and tire size. Directional estimate.",
    tags: ["Speed", "Brushed", "Turns"],
  },
  {
  ...
  },
  {
    href: "/tools/gas-mix",
    icon: "🧪",
    title: "Gas Mix Ratio Calculator",
    description: "Calculate how much 2-stroke oil to add to your fuel at any mix ratio.",
    tags: ["Nitro", "Gas", "Mix"],
  },
  {
