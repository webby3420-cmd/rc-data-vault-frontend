...
export const metadata: Metadata = {
  title: "Best RC Desert Trucks | RC Data Vault",
  description: "Top RC desert trucks and trophy trucks ranked by real sold market data. Compare fair values, price ranges, and market confidence.",
};
    ...
    <main className="min-h-screen bg-slate-950 text-slate-100">
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
        <nav className="mb-6 text-sm text-slate-400">
          ...
          <span className="text-slate-300">Desert Trucks</span>
        </nav>
        <h1 className="mb-2 text-3xl font-semibold text-white">Best RC Desert Trucks</h1>
